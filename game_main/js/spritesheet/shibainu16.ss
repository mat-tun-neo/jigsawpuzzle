...
let x = [ 150.0, 258.0, 385.5, 478.5, 150.0, 243.5, 357.0, 464.5, 151.5, 259.0, 371.5, 464.5, 151.5, 244.5, 371.0, 478.5 ];              // フレーム画像の表示位置X
let y = [ 118.5, 117.0, 118.5, 118.5, 212.5, 211.5, 211.5, 212.5, 337.5, 337.5, 324.0, 323.5, 445.5, 445.5, 431.5, 431.5 ];              // フレーム画像の表示位置Y
