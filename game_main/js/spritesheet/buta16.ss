...
let x = [ 165.5, 258.0, 369.5, 478.5, 166.5, 261.0, 370.5, 478.5, 166.5, 260.0, 371.0, 478.5, 165.0, 260.5, 356.5, 464.5 ];              // フレーム画像の表示位置X
let y = [ 118.5, 132.0, 133.5, 118.5, 212.5, 227.5, 228.0, 226.5, 323.5, 337.5, 322.5, 351.5, 431.5, 445.5, 432.0, 445.5 ];              // フレーム画像の表示位置Y
