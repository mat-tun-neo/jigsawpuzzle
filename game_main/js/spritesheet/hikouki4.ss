...
const PIECE_IMAGE = 'hikouki4';            // ピースの画像名
let width  = [ 257, 330, 263, 326 ];        // 画像サイズX
let height = [ 326, 263, 262, 326 ];        // 画像サイズY
let x = [ 188.5, 395.0, 191.5, 397.0 ];              // フレーム画像の表示位置X
let y = [ 224.0, 192.5, 430.0, 398.0 ];              // フレーム画像の表示位置Y
